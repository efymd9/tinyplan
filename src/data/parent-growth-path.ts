...
export const PARENT_GROWTH_PATH: ParentSkill[] = [
  {
    id: "small-control",
    dayNumber: 1,
    title: "Small Control",
...
export function getSkillByDay(dayNumber: number): ParentSkill | undefined {
  return PARENT_GROWTH_PATH.find((s) => s.dayNumber === dayNumber);
}

export function getSkillById(id: string): ParentSkill | undefined {
  return PARENT_GROWTH_PATH.find((s) => s.id === id);
}
