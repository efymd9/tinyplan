// Root 404 for unmatched, non-localized URLs (and invalid-locale paths where
// app/[lang]/layout.tsx calls notFound()). Renders inside the root layout, so
// globals.css/Tailwind apply. Locale comes from the proxy-set cookie (default es);
// links route to the localized home so the user lands inside a valid locale tree.
...
const COPY = {
  es: {
    ...
    body: "El enlace puede estar roto o la página ya no existe. Te llevamos de vuelta al inicio.",
    home: "Volver al inicio",
  },
  en: {
    code: "404",
    title: "Page not found",
    body: "The link may be broken or the page no longer exists. Let's take you back home.",
    home: "Go home",
  },
} as const;
